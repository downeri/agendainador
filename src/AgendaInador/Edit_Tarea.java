...
public class Edit_Tarea {
    ...
    JButton jbtconfirm3 = new JButton("Guardar Cambios");//Se crea el boton Confirmar
    JDateChooser calendario=new JDateChooser();
    
    
    public Edit_Tarea(int clave_usuario, String desc, Date fecha,String materia){
        desc_edit=desc;
        calendario.setDate(fecha);
        jtf_desc_materia.setText(desc);
        jtf_nombre_materia.setSelectedItem(materia);
        this.clave_usuario=clave_usuario;
        frame.setTitle("Editar Tarea");
        ...
        jlb12.setBounds(380,260,800,60);//Le damos especificaciones de tamaño y un lugar dentro de la pantalla creada a JL12
        jlb12.setFont(new java.awt.Font("Arial", 0, 24));
        jlb13.setBounds(50,20,800,60);//Le damos especificaciones de tamaño y un lugar dentro de la pantalla creada
        ...
        jlb14.setBounds(50,240,800,60);//Le damos especificaciones de tamaño y un lugar dentro de la pantalla creada 
        ...
        jlb15.setBounds(50,180,800,60);//Le damos especificaciones de tamaño y un lugar dentro de la pantalla creada 
        jlb15.setFont(new java.awt.Font("Arial", 0, 24));
        jtf_desc_materia.setBorder(new javax.swing.border.EtchedBorder());
        jbtconfirm3.setBounds(750,450,300,60);
    ...
    public void editar() {
        String desc_tarea_editado=jtf_desc_materia.getText();
        Date dia_editado=calendario.getDate();
        String nombre_materia_editado=String.valueOf(jtf_nombre_materia.getSelectedItem());
        if(desc_tarea_editado!=null||dia_editado!=null||nombre_materia_editado!=null){
            java.sql.Date fecha_entrega_editada=new java.sql.Date(dia_editado.getTime());
            Base_Datos tarea=new Base_Datos(clave_usuario,desc_edit, desc_tarea_editado,fecha_entrega_editada,nombre_materia_editado);
